...
export default {
  ...
  content: stripIndent`
    ...
    With actions, you can inspect events of your components. This is pretty neat when you are manually testing your components.

    Also, you can think this as a way to document events in your components.
    ...
    If you are using Storybook as a style guide, then this addon will help you to build a nice looking Style Guide with docs, automatic sample source code and with a PropTypes explorer.
  `
};
